...
$key = "slider_id";
$tableName = "e_slider";
$fields = array('Slider Name','Date');
$indexes = array('slider_name','slider_date'); 
 ?>
<!-- BEGIN .app-main -->
				<div class="app-main">
					<!-- BEGIN .main-heading -->
...
{   
   ...
   // $("#editorReplace").val(value);
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>function_control/saveSliderData',
      data: form,
      cache: false,
      contentType: false,
      processData: false,
				...
				<form method="POST" name="myForm" id="myForm"  enctype="multipart/form-data" onsubmit="return form_validation()">
		           <div class="form-group row">
		            <div class="col-md-6">
		              ...
		              <input type="text" required name="slider_name"  class="form-control-sm form-control">
		            </div> 
		          <!--   <div class="col-md-6">
