...
$key = "wallet_id";
$tableName = "e_wallet";
$fields = array('Wallet Id','Reward Amount','Wallet Status');
$indexes = array('wallet_id','wallet_total_amount','wallet_reward_status');
										...
										<table id="datatable" class="table table-striped table-bordered">
											...
											<?php foreach ($data as $row):?>
											  <tr id="row<?=$row[$key]?>">
												...
												?></td>
												<td><?=$reward=getField('e_reward',array('reward_id'=>$row['wallet_reward_id']),'reward_name');
