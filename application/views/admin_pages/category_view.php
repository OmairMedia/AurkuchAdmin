...
$fields = array('Category Name','Date');
$indexes = array('category_name','category_date'); 
 ?>
<!-- BEGIN .app-main -->
				<div class="app-main">
					<!-- BEGIN .main-heading -->
				...
				<form method="POST" name="myForm" id="myForm"  enctype="multipart/form-data" onsubmit="return form_validation()">
		           <div class="form-group row">
		            <div class="col-md-6">
		              ...
		              <input type="text" required name="category_name"  class="form-control-sm form-control">
		            </div> 
		          <!--   <div class="col-md-6">
